...
const CATALOG: SeedGroup[] = [
  {
    ...
    services: [
      companyService("company", "Company Registration", "Company", "SPICe+ / INC-32", 2499, 1000, 500, 1500),
      companyService("company-pvt", "Private Limited Company", "Private Limited", "SPICe+ INC-32", 2499, 1000, 500, 1500),
      companyService("company-public", "Public Limited Company", "Public Limited", "SPICe+ INC-32", 6499, 2500, 1000, 1500),
      companyService("company-opc", "One Person Company (OPC)", "OPC", "SPICe+ INC-32", 2499, 1000, 500, 1500),
